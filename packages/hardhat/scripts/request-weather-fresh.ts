...
async function main() {
  ...
  // Configuration - UPDATE THIS ADDRESS AFTER DEPLOYMENT
  const contractAddress = "REPLACE_WITH_NEW_CONTRACT_ADDRESS"; // Will be updated after deployment
  const subscriptionId = 5274; // Your subscription ID
